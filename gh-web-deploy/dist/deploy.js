...
exports.DeployExecutor = exports.DeployParameters = void 0;
const crawl = __importStar(require("./crawl"));
class DeployParameters {
    constructor(minifySrc, minifyResourceRef, stripJSMacro, generateArtifacts) {
...
exports.DeployParameters = DeployParameters;
class DeployExecutor {
    ...
    dispatch() {
        return __awaiter(this, void 0, void 0, function* () {
            yield crawl.crawlJavascriptSource('src/');
        });
    }
    cleanup() {
        return __awaiter(this, void 0, void 0, function* () {
